...
# julia /media/david/72CADE2ECADDEDFB/PomonaData/MakeWavPngCsv/AvianzJSONtoWavPngCsv.jl
...
cd to PomonaData/LinuxLabels
julia
x = glob("*/2022-10-08")
for i in x
cd(i)
include("/media/david/72CADE2ECADDEDFB/Pomona/PomonaData/MakeWavPngCsv/AvianzJSONtoWavPngCsv.jl")
cd("../..")
end
=#
